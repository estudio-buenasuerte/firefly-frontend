...
const CaseStudy = () => {
	...
	return (
		<Layout>
			<SEO metaTitle='Case Study' description='' />
			<HeroSection>
			...
			<Step data-id={caseStudy.step1Title}>
				...
				<StepSectionAsset className='step-asset'>
					{caseStudy.step1Asset.asset.url.split('.')[caseStudy.step1Asset.asset.url.split('.').length - 1] ===
						'gif' ||
					caseStudy.step1Asset.asset.url.split('.')[caseStudy.step1Asset.asset.url.split('.').length - 1] ===
						'png' ||
					caseStudy.step1Asset.asset.url.split('.')[caseStudy.step1Asset.asset.url.split('.').length - 1] ===
						'jpg' ? (
						<img src={caseStudy.step1Asset.asset.url} alt={caseStudy.step1Title} />
					) : (
						<>
							<VideoMask />
							<Player
			...
			<Step data-id={caseStudy.step2Title}>
				...
				<StepSectionAsset className='step-asset'>
					{caseStudy.step2Asset.asset.url.split('.')[caseStudy.step2Asset.asset.url.split('.').length - 1] ===
						'gif' ||
					caseStudy.step2Asset.asset.url.split('.')[caseStudy.step2Asset.asset.url.split('.').length - 1] ===
						'png' ||
					caseStudy.step2Asset.asset.url.split('.')[caseStudy.step2Asset.asset.url.split('.').length - 1] ===
						'jpg' ? (
						<img src={caseStudy.step2Asset.asset.url} alt={caseStudy.step2Title} />
					) : (
						<>
							<VideoMask />
							<Player
			...
			<Step data-id={caseStudy.step3Title}>
				...
				<StepSectionAsset className='step-asset'>
					{caseStudy.step3Asset.asset.url.split('.')[caseStudy.step3Asset.asset.url.split('.').length - 1] ===
						'gif' ||
					caseStudy.step3Asset.asset.url.split('.')[caseStudy.step3Asset.asset.url.split('.').length - 1] ===
						'png' ||
					caseStudy.step3Asset.asset.url.split('.')[caseStudy.step3Asset.asset.url.split('.').length - 1] ===
						'jpg' ? (
						<img src={caseStudy.step3Asset.asset.url} alt={caseStudy.step3Title} />
					) : (
						<>
							<VideoMask />
							<Player
			...
			<Step data-id={caseStudy.step4Title}>
				...
				<StepSectionAsset className='step-asset'>
					{caseStudy.step4Asset.asset.url.split('.')[caseStudy.step4Asset.asset.url.split('.').length - 1] ===
						'gif' ||
					caseStudy.step4Asset.asset.url.split('.')[caseStudy.step4Asset.asset.url.split('.').length - 1] ===
						'png' ||
					caseStudy.step4Asset.asset.url.split('.')[caseStudy.step4Asset.asset.url.split('.').length - 1] ===
						'jpg' ? (
						<img src={caseStudy.step4Asset.asset.url} alt={caseStudy.step4Title} />
					) : (
						<>
							<VideoMask />
							<Player
			...
			<Step data-id={caseStudy.step5Title}>
				...
				<StepSectionAsset className='step-asset'>
					{caseStudy.step5Asset.asset.url.split('.')[caseStudy.step5Asset.asset.url.split('.').length - 1] ===
						'gif' ||
					caseStudy.step5Asset.asset.url.split('.')[caseStudy.step5Asset.asset.url.split('.').length - 1] ===
						'png' ||
					caseStudy.step5Asset.asset.url.split('.')[caseStudy.step5Asset.asset.url.split('.').length - 1] ===
						'jpg' ? (
						<img src={caseStudy.step5Asset.asset.url} alt={caseStudy.step5Title} />
					) : (
						<>
							<VideoMask />
							<Player
			...
			<Step data-id={caseStudy.step6Title}>
				...
				<StepSectionAsset className='step-asset'>
					{caseStudy.step6Asset.asset.url.split('.')[caseStudy.step6Asset.asset.url.split('.').length - 1] ===
						'gif' ||
					caseStudy.step6Asset.asset.url.split('.')[caseStudy.step6Asset.asset.url.split('.').length - 1] ===
						'png' ||
					caseStudy.step6Asset.asset.url.split('.')[caseStudy.step6Asset.asset.url.split('.').length - 1] ===
						'jpg' ? (
						<img src={caseStudy.step6Asset.asset.url} alt={caseStudy.step6Title} />
					) : (
						<>
							<VideoMask />
							<Player
